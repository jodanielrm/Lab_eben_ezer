...
Public Class CRInmunologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio_Eben_Ezer.CRInmunologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRInmunologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRInmunologia = New CRInmunologia()
        rpt.Site = Me.Site
        Return rpt
    End Function

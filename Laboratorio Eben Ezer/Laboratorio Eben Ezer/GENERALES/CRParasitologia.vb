...
Public Class CRParasitologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio_Eben_Ezer.CRParasitologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRParasitologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRParasitologia = New CRParasitologia()
        rpt.Site = Me.Site
        Return rpt
    End Function

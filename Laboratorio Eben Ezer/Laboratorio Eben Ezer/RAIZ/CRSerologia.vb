...
Public Class CRSerologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio_Eben_Ezer.CRSerologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSerologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSerologia = New CRSerologia()
        rpt.Site = Me.Site
        Return rpt
    End Function

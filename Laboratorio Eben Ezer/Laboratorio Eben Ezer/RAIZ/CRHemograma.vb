...
Public Class CRHemograma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio_Eben_Ezer.CRHemograma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRHemograma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRHemograma = New CRHemograma()
        rpt.Site = Me.Site
        Return rpt
    End Function

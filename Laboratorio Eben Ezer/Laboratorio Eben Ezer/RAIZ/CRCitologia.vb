...
Public Class CRCitologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Laboratorio_Eben_Ezer.CRCitologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCitologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCitologia = New CRCitologia()
        rpt.Site = Me.Site
        Return rpt
    End Function
